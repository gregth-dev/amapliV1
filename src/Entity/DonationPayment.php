...
use App\Repository\DonationPaymentRepository;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * @ORM\Entity(repositoryClass=DonationPaymentRepository::class)
 */
class DonationPayment
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Donation::class, inversedBy="payment")
